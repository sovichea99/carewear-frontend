        ...
        <div className="fixed inset-0 bg-black bg-opacity-5 backdrop-blur-sm flex items-center justify-center z-50">
            ...
            >
                <button
                    ...
                    className="absolute top-4 right-4 px-4 py-2 bg-pink-500 text-white font-semibold rounded-xl hover:bg-pink-700 z-10"
                >
                    X
                </button>
                ...
                <button
                    ...
                    className="absolute flex bottom-4 right-5 px-4 py-2 bg-pink-500 text-white font-semibold rounded-xl hover:bg-pink-700 z-10"
                >
