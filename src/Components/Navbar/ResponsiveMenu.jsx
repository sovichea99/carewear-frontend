    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-0 z-50 bg-pink-400 bg-opacity-65 backdrop-blur-sm"
        >
          {/* Cancel Button */}
                    ...
                    {user ? (
                      <>
                        <li
                          ...
                          className=" text-white hover:text-pink-300 px-4 w-full py-2 rounded-md flex items-center gap-2  cursor-pointer"
                        >
                      ...
                      <li
                        ...
                        className="hover:bg-pink-100 px-4 py-2 rounded-md cursor-pointer flex items-center gap-2"
                      >
