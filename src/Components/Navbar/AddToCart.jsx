          ...
          {cartItems.length === 0 ? (
            ...
            <>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-center border-t border-gray-300 pt-4 mt-6">
                ...
                <span className="text-xl sm:text-2xl font-semibold text-pink-500">${calculateTotal()}</span>
              </div>

              <div className="mt-6">
                <button
                  onClick={handlePaymentClick}
                  className="w-full py-3 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 flex items-center justify-center"
                >
